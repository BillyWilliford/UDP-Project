      ...
      while (true) {
         ...
         while (dataOffset != -1) {
            ...
            // Else, make packet header packet
               ...
               fullMessage = fullMessage.concat(message);
            }
         ...
         System.out.println("The message sent from the server was: \n" + fullMessage);
      }
   }
   
   public static String getData(String packetInfo) {
   ...
   public static byte[] padPacketWithSpaces(byte[] header) {
      ...
      for (int offset = 0; offset < paddedHeader.length; offset++) {
         if (offset < header.length) {
            ...
            paddedHeader[offset] = 32; //32 is ASCII value for space
         }
      }
      return paddedHeader;
   }

   public static String makeFileHeader(int packetNum, long contentLength) {
      String pseudoHeader =
